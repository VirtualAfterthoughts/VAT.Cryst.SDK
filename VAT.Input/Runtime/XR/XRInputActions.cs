...
namespace VAT.Input.XR
{
    ...
    ""controlSchemes"": []
        ...
        ~@XRInputActions()
        {
            UnityEngine.Debug.Assert(!m_HMD.enabled, "This will cause a leak and performance issues, XRInputActions.HMD.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_ControllerLeft.enabled, "This will cause a leak and performance issues, XRInputActions.ControllerLeft.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_ControllerRight.enabled, "This will cause a leak and performance issues, XRInputActions.ControllerRight.Disable() has not been called.");
        }
