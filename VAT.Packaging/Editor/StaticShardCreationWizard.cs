...
namespace VAT.Packaging.Editor
{
    public class StaticShardCreationWizard : EditorWindow
    {
        ...
        private StaticShardIdentifierAttribute _contentIdentifier;
        ...
        public static void Initialize(Crystal crystal, StaticShardIdentifierAttribute identifier, Type contentType, Object mainAsset)
        {
            StaticShardCreationWizard window = GetWindow<StaticShardCreationWizard>(true, "Shard Creator");
            window._crystal = crystal;
        ...
        {
            StaticShard content = ShardFactory.Create(_contentType) as StaticShard;
            content.ShardInfo = new ShardInfo()
            {
                Title = _title
            };
            content.StaticCrystal = _crystal;
